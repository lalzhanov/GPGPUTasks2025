	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			std::cout << "        Device types: " <<
		        ...
		        (deviceType & CL_DEVICE_TYPE_DEFAULT ? "DEFAULT " : "") <<
		        (deviceType & CL_DEVICE_TYPE_CUSTOM ? "CUSTOM " : "") <<
				std::endl;
			...
			std::cout << "        Device global memory size: " << (deviceGlobalMemSize >> 20) << " MB" << std::endl;
			...
			cl_ulong deviceMaxClockFrequency = 0;
			...
			size_t deviceMaxComputeUnitsSize = 0;
			OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_MAX_COMPUTE_UNITS, 0, nullptr, &deviceMaxComputeUnitsSize));
			cl_ulong deviceMaxComputeUnits = 0;
			OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_MAX_COMPUTE_UNITS, deviceMaxComputeUnitsSize, &deviceMaxComputeUnits, nullptr));
